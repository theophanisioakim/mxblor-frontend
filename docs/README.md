# Mxblor frontend documentation

**Snapshot date:** 2026-07-23
**Applies to:** `mxblor-frontend`
**Status:** Current implementation

This directory is the documentation entry point for the Mxblor cross-platform client. It describes
the implemented Next.js web app, Expo native app, building-management and administration screens,
shared UI abstraction, API integration, and client-visible behavior.
