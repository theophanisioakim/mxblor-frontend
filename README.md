...
A cross-platform Mxblor React monorepo that renders shared building-management screens and
application chrome in:

- a Next.js web application;
- an Expo/React Native application.

The client consumes the sibling `mxblor-backend` OpenAPI contract through a generated API package.
